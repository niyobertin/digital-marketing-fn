...
const HeroSection:React.FC =() =>{
    return(
        ...
        style={{
           ...
           <h1 className="text-5xl mt-[14%] text-center pb-[8%] font-bold animate-slidein opacity-0 [--slidein-delay:300ms]">Unlock The Power Of your business</h1>
           <div className="text-center text-[#FFFFFF] text-xl mr-[30%] ml-[30%] animate-slidein opacity-0 [--slidein-delay:600ms]">
            <p className="">
           ...
           <div className="flex items-center justify-center animate-slidein opacity-0 [--slidein-delay:900ms]">
            <button className="p-[1%] bg-gradient-to-r from-[#98AA28] to-[#D6EF7E] font-bold mt-[6%] rounded-[30px] px-8">Get Started</button>
           </div>
           </div>
        </div>
    )
