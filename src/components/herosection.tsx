...
const HeroSection:React.FC =() =>{
    return(
        ...
        style={{
           ...
           <h1 className="sm:text-5xl text-xl sm:mt-[14%] mt-[35%] text-center pb-[8%] font-bold animate-slidein opacity-0 [--slidein-delay:300ms]">Unlock The Power Of your business</h1>
